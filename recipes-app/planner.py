...
_ROLE = {"protein": "белок", "carb": "сложный углевод", "veg": "овощи"}
_TAIL = {"protein": "белок", "carb": "гарнир", "veg": "овощи"}
_SHARES = {"protein": 0.30, "carb": 0.32, "veg": 0.15}
...
def build_meal(kind, kcal, exclude="", avoid_id=None, overnight=True,
    ...
    pickers = {"carb": lambda: random.choice(garnishes), "veg": lambda: random.choice(vegs),
               "protein": lambda: random.choice(prot)}
